...
function getVoucherAccountDataSerializer(_context = {}) {
...
function deserializeVoucher(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getVoucherAccountDataSerializer());
}
