...
export declare function getVoucherAccountDataSerializer(_context: object): Serializer<VoucherAccountDataArgs, VoucherAccountData>;
...
export declare function deserializeVoucher(context: object, rawAccount: RpcAccount): Voucher;
