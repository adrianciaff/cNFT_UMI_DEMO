...
export declare function getSetAndVerifySizedCollectionItemInstructionDataSerializer(_context: object): Serializer<SetAndVerifySizedCollectionItemInstructionDataArgs, SetAndVerifySizedCollectionItemInstructionData>;
...
export declare function setAndVerifySizedCollectionItem(context: Pick<Context, 'programs' | 'identity' | 'payer'>, input: SetAndVerifySizedCollectionItemInstructionAccounts): TransactionBuilder;
