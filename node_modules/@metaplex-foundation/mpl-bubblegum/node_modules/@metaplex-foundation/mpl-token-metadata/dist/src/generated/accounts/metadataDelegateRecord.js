...
function getMetadataDelegateRecordAccountDataSerializer(_context = {}) {
...
function deserializeMetadataDelegateRecord(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getMetadataDelegateRecordAccountDataSerializer());
}
