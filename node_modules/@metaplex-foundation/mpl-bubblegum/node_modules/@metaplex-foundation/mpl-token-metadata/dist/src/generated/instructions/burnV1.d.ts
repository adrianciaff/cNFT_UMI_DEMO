...
export declare function getBurnV1InstructionDataSerializer(_context: object): Serializer<BurnV1InstructionDataArgs, BurnV1InstructionData>;
...
export declare function burnV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: BurnV1InstructionAccounts & BurnV1InstructionArgs): TransactionBuilder;
