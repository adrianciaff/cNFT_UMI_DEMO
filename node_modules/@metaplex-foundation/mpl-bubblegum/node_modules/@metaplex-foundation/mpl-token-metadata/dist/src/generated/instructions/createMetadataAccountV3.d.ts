...
export declare function getCreateMetadataAccountV3InstructionDataSerializer(_context: object): Serializer<CreateMetadataAccountV3InstructionDataArgs, CreateMetadataAccountV3InstructionData>;
...
export declare function createMetadataAccountV3(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: CreateMetadataAccountV3InstructionAccounts & CreateMetadataAccountV3InstructionArgs): TransactionBuilder;
