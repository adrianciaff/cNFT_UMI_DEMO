...
export declare function getDelegateTransferV1InstructionDataSerializer(_context: object): Serializer<DelegateTransferV1InstructionDataArgs, DelegateTransferV1InstructionData>;
...
export declare function delegateTransferV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: DelegateTransferV1InstructionAccounts & DelegateTransferV1InstructionArgs): TransactionBuilder;
