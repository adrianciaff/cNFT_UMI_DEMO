...
function getTokenRecordAccountDataSerializer(_context = {}) {
...
function deserializeTokenRecord(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getTokenRecordAccountDataSerializer());
}
