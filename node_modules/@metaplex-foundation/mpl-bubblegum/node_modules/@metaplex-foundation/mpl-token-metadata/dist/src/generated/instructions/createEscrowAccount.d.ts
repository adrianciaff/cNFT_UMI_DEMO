...
export declare function getCreateEscrowAccountInstructionDataSerializer(_context: object): Serializer<CreateEscrowAccountInstructionDataArgs, CreateEscrowAccountInstructionData>;
...
export declare function createEscrowAccount(context: Pick<Context, 'programs' | 'eddsa' | 'payer'>, input: CreateEscrowAccountInstructionAccounts): TransactionBuilder;
