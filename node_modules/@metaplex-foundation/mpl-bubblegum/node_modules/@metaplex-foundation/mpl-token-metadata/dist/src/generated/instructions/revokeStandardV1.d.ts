...
/** @deprecated Use `getRevokeStandardV1InstructionDataSerializer()` without any argument instead. */
export declare function getRevokeStandardV1InstructionDataSerializer(_context: object): Serializer<RevokeStandardV1InstructionDataArgs, RevokeStandardV1InstructionData>;
...
export declare function revokeStandardV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: RevokeStandardV1InstructionAccounts & RevokeStandardV1InstructionArgs): TransactionBuilder;
