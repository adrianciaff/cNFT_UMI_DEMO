...
function getMasterEditionAccountDataSerializer(_context = {}) {
...
function deserializeMasterEdition(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getMasterEditionAccountDataSerializer());
}
...
function getMasterEditionSize() {
    return 282;
}
exports.getMasterEditionSize = getMasterEditionSize;
