...
function getUpdateAsDataDelegateV2InstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.u8)()],
        ['updateAsDataDelegateV2Discriminator', (0, serializers_1.u8)()],
        [
            'data',
            (0, serializers_1.option)((0, serializers_1.struct)([
...
function updateAsDataDelegateV2(context, input) {
    ...
    (0, shared_1.addObjectProperty)(resolvingArgs, 'delegateMint', input.delegateMint ?? (0, umi_1.publicKey)(input.mint, false));
    (0, shared_1.addObjectProperty)(resolvingArgs, 'delegateUpdateAuthority', input.delegateUpdateAuthority ?? context.identity.publicKey);
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'delegateRecord', input.delegateRecord
        ...
        : [
            (0, accounts_1.findMetadataDelegateRecordPda)(context, {
                ...
                delegate: (0, umi_1.publicKey)(resolvedAccounts.authority[0], false),
            }),
            false,
        ]);
