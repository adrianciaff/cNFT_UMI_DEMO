...
export declare function getDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionDataSerializer(_context: object): Serializer<DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionDataArgs, DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionData>;
...
export declare function deprecatedMintNewEditionFromMasterEditionViaPrintingToken(context: Pick<Context, 'programs' | 'eddsa' | 'payer'>, input: DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionAccounts): TransactionBuilder;
