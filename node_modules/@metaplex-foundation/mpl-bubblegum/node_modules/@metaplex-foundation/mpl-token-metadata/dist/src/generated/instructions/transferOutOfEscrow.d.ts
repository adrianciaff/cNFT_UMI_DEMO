...
export declare function getTransferOutOfEscrowInstructionDataSerializer(_context: object): Serializer<TransferOutOfEscrowInstructionDataArgs, TransferOutOfEscrowInstructionData>;
...
export declare function transferOutOfEscrow(context: Pick<Context, 'programs' | 'payer'>, input: TransferOutOfEscrowInstructionAccounts & TransferOutOfEscrowInstructionArgs): TransactionBuilder;
