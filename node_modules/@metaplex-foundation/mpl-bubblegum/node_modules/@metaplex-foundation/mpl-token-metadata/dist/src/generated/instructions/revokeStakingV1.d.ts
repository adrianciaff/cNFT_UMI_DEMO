...
export declare function getRevokeStakingV1InstructionDataSerializer(_context: object): Serializer<RevokeStakingV1InstructionDataArgs, RevokeStakingV1InstructionData>;
...
export declare function revokeStakingV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: RevokeStakingV1InstructionAccounts & RevokeStakingV1InstructionArgs): TransactionBuilder;
