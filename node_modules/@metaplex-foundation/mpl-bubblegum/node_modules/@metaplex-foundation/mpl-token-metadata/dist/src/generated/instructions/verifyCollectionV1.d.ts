...
export declare function getVerifyCollectionV1InstructionDataSerializer(_context: object): Serializer<VerifyCollectionV1InstructionDataArgs, VerifyCollectionV1InstructionData>;
...
export declare function verifyCollectionV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity'>, input: VerifyCollectionV1InstructionAccounts): TransactionBuilder;
