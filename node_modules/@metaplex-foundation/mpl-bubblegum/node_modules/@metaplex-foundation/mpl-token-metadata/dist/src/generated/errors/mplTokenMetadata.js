...
class UpdateAuthorityMustBeEqualToMetadataAuthorityAndSignerError extends umi_1.ProgramError {
    constructor(program, cause) {
        super("Update authority must be equivalent to the metadata's authority and also signer of this transaction", program, cause);
...
class MasterRecordMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The master edition record passed must match the master record on the edition given', program, cause);
...
class DestinationMintMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The destination account does not have the right mint', program, cause);
...
class OneTimePrintingAuthorizationMintDecimalsShouldBeZeroError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('OneTimePrintingAuthorization mint decimals should be zero', program, cause);
...
class TokenAccountOneTimeAuthMintMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The One Time authorization mint does not match that on the token account!', program, cause);
...
class PrintingMintAuthorizationAccountMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The mint on your authorization token holding account does not match your Printing mint!', program, cause);
...
class AuthorizationTokenAccountOwnerMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The authorization token account has a different owner than the update authority for the master edition!', program, cause);
...
class MustBeOneOfCreatorsError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('If using a creators array, you must be one of the creators listed', program, cause);
...
class ReservationNotSetError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('This reservation list exists but was never set with reservations', program, cause);
...
class BeyondMaxAddressSizeError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Provided more addresses than max allowed in single reservation', program, cause);
...
class ReservationBreachesMaximumSupplyError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('This reservation would go beyond the maximum supply of the master edition!', program, cause);
...
class SpotMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('In initial reservation setting, spots remaining should equal total spots', program, cause);
...
class PrintingWouldBreachMaximumSupplyError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('printing these tokens would breach the maximum supply limit of the master edition', program, cause);
...
class ReservationSpotsRemainingShouldMatchTotalSpotsAtStartError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Reservation spots remaining should match total spots when first being created', program, cause);
...
class ReservationArrayShouldBeSizeOneError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('In the legacy system the reservation needs to be of size one for cpu limit reasons', program, cause);
...
class MustBeBurnedError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('This token use method is burn and there are no remaining uses, it must be burned', program, cause);
...
class CannotAdjustVerifiedCreatorError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Creator can not be adjusted once they are verified.', program, cause);
