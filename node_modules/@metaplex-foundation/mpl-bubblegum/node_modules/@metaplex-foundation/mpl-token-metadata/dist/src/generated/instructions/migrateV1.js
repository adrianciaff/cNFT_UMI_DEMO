...
exports.migrateV1 = exports.getMigrateV1InstructionDataSerializer = void 0;
...
function getMigrateV1InstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.u8)()],
        ['migrateV1Discriminator', (0, serializers_1.u8)()],
        ['migrationType', (0, types_1.getMigrationTypeSerializer)()],
...
function migrateV1(context, input) {
    ...
    const resolvedAccounts = {
        ...
        tokenOwner: [input.tokenOwner, false],
        mint: [input.mint, false],
        collectionMetadata: [input.collectionMetadata, false],
        delegateRecord: [input.delegateRecord, false],
    };
    const resolvingArgs = {};
    ...
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'tokenRecord', input.tokenRecord
        ...
        : [
            (0, accounts_1.findTokenRecordPda)(context, {
                ...
                token: (0, umi_1.publicKey)(input.token, false),
            }),
            true,
        ]);
...
//# sourceMappingURL=migrateV1.js.map