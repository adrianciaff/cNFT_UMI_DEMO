...
export declare function getUpdateV1InstructionDataSerializer(_context: object): Serializer<UpdateV1InstructionDataArgs, UpdateV1InstructionData>;
...
export declare function updateV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: UpdateV1InstructionAccounts & UpdateV1InstructionArgs): TransactionBuilder;
