...
export declare function getDelegateStandardV1InstructionDataSerializer(_context: object): Serializer<DelegateStandardV1InstructionDataArgs, DelegateStandardV1InstructionData>;
...
export declare function delegateStandardV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: DelegateStandardV1InstructionAccounts & DelegateStandardV1InstructionArgs): TransactionBuilder;
