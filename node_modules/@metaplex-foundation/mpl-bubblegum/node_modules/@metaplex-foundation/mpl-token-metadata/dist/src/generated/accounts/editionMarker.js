...
function getEditionMarkerAccountDataSerializer(_context = {}) {
...
function deserializeEditionMarker(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getEditionMarkerAccountDataSerializer());
}
