...
export declare function getCreateV1InstructionDataSerializer(_context: object): Serializer<CreateV1InstructionDataArgs, CreateV1InstructionData>;
...
export declare function createV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: CreateV1InstructionAccounts & CreateV1InstructionArgs): TransactionBuilder;
