...
function getMintNewEditionFromMasterEditionViaVaultProxyInstructionDataSerializer(_context = {}) {
...
function mintNewEditionFromMasterEditionViaVaultProxy(context, input) {
    ...
    const resolvedAccounts = {
        ...
        vaultAuthority: [input.vaultAuthority, false],
        safetyDepositStore: [input.safetyDepositStore, false],
        safetyDepositBox: [input.safetyDepositBox, false],
        ...
        tokenVaultProgram: [input.tokenVaultProgram, false],
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.vaultAuthority, false);
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.safetyDepositStore, false);
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.safetyDepositBox, false);
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.vault, false);
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.tokenVaultProgram, false);
