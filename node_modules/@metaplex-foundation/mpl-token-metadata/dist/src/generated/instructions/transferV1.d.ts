...
export declare function getTransferV1InstructionDataSerializer(_context: object): Serializer<TransferV1InstructionDataArgs, TransferV1InstructionData>;
...
export declare function transferV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: TransferV1InstructionAccounts & TransferV1InstructionArgs): TransactionBuilder;
