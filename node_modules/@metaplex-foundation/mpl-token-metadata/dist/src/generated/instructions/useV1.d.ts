...
export declare function getUseV1InstructionDataSerializer(_context: object): Serializer<UseV1InstructionDataArgs, UseV1InstructionData>;
...
export declare function useV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: UseV1InstructionAccounts & UseV1InstructionArgs): TransactionBuilder;
