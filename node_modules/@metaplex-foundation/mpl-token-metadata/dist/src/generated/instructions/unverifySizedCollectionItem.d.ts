...
export declare function getUnverifySizedCollectionItemInstructionDataSerializer(_context: object): Serializer<UnverifySizedCollectionItemInstructionDataArgs, UnverifySizedCollectionItemInstructionData>;
...
export declare function unverifySizedCollectionItem(context: Pick<Context, 'programs' | 'payer'>, input: UnverifySizedCollectionItemInstructionAccounts): TransactionBuilder;
