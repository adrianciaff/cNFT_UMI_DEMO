...
export declare function getPrintV1InstructionDataSerializer(_context: object): Serializer<PrintV1InstructionDataArgs, PrintV1InstructionData>;
...
export declare function printV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: PrintV1InstructionAccounts & PrintV1InstructionArgs): TransactionBuilder;
