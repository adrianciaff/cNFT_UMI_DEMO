...
function getUnlockV1InstructionDataSerializer(_context = {}) {
...
function unlockV1(context, input) {
    ...
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'tokenOwner', input.tokenOwner
        ? [input.tokenOwner, false]
        : (0, hooked_1.resolveOptionalTokenOwner)(context, { ...input, ...resolvedAccounts }, { ...input, ...resolvingArgs }, programId, false));
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'token', input.token
        ...
        : [
            (0, mpl_toolbox_1.findAssociatedTokenPda)(context, {
                ...
                owner: (0, umi_1.publicKey)(resolvedAccounts.tokenOwner[0], false),
            }),
            true,
        ]);
    ...
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'splTokenProgram', input.splTokenProgram
        ...
        : (0, hooked_1.resolveTokenProgramForNonProgrammables)(context, { ...input, ...resolvedAccounts }, { ...input, ...resolvingArgs }, programId, false));
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.tokenOwner, false);
