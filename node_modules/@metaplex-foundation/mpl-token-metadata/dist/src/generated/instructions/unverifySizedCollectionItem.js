...
function getUnverifySizedCollectionItemInstructionDataSerializer(_context = {}) {
...
function unverifySizedCollectionItem(context, input) {
    ...
    const resolvedAccounts = {
        ...
        collectionAuthority: [input.collectionAuthority, false],
        collectionMint: [input.collectionMint, false],
        collection: [input.collection, true],
