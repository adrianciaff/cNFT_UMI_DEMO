...
export declare function getUpdateAsDataDelegateV2InstructionDataSerializer(_context: object): Serializer<UpdateAsDataDelegateV2InstructionDataArgs, UpdateAsDataDelegateV2InstructionData>;
...
export declare function updateAsDataDelegateV2(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: UpdateAsDataDelegateV2InstructionAccounts & UpdateAsDataDelegateV2InstructionArgs): TransactionBuilder;
