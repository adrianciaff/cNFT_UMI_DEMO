...
export declare function getDelegateProgrammableConfigV1InstructionDataSerializer(_context: object): Serializer<DelegateProgrammableConfigV1InstructionDataArgs, DelegateProgrammableConfigV1InstructionData>;
...
export declare function delegateProgrammableConfigV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: DelegateProgrammableConfigV1InstructionAccounts & DelegateProgrammableConfigV1InstructionArgs): TransactionBuilder;
