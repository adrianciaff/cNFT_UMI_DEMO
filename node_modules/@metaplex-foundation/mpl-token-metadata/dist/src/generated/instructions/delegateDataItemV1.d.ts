...
export declare function getDelegateDataItemV1InstructionDataSerializer(_context: object): Serializer<DelegateDataItemV1InstructionDataArgs, DelegateDataItemV1InstructionData>;
...
export declare function delegateDataItemV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: DelegateDataItemV1InstructionAccounts & DelegateDataItemV1InstructionArgs): TransactionBuilder;
