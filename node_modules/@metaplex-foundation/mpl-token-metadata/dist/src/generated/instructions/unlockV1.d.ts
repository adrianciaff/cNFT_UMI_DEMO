...
export declare function getUnlockV1InstructionDataSerializer(_context: object): Serializer<UnlockV1InstructionDataArgs, UnlockV1InstructionData>;
...
export declare function unlockV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: UnlockV1InstructionAccounts & UnlockV1InstructionArgs): TransactionBuilder;
