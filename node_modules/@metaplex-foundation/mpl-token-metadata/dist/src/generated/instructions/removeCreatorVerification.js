...
function getRemoveCreatorVerificationInstructionDataSerializer(_context = {}) {
...
function removeCreatorVerification(context, input) {
    ...
    const resolvedAccounts = {
        ...
        creator: [input.creator, false],
    };
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.metadata, false);
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.creator, false);
    // Data.
