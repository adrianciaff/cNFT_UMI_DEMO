...
export declare function getCreateMasterEditionV3InstructionDataSerializer(_context: object): Serializer<CreateMasterEditionV3InstructionDataArgs, CreateMasterEditionV3InstructionData>;
...
export declare function createMasterEditionV3(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: CreateMasterEditionV3InstructionAccounts & CreateMasterEditionV3InstructionArgs): TransactionBuilder;
