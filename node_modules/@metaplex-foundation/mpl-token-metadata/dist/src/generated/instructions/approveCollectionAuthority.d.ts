...
export declare function getApproveCollectionAuthorityInstructionDataSerializer(_context: object): Serializer<ApproveCollectionAuthorityInstructionDataArgs, ApproveCollectionAuthorityInstructionData>;
...
export declare function approveCollectionAuthority(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: ApproveCollectionAuthorityInstructionAccounts): TransactionBuilder;
