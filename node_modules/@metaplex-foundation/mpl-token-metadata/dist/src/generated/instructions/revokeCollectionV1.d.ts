...
export declare function getRevokeCollectionV1InstructionDataSerializer(_context: object): Serializer<RevokeCollectionV1InstructionDataArgs, RevokeCollectionV1InstructionData>;
export declare function getRevokeCollectionV1InstructionDataSerializer(): Serializer<RevokeCollectionV1InstructionDataArgs, RevokeCollectionV1InstructionData>;
...
export declare function revokeCollectionV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: RevokeCollectionV1InstructionAccounts & RevokeCollectionV1InstructionArgs): TransactionBuilder;
