...
export declare function getUtilizeInstructionDataSerializer(_context: object): Serializer<UtilizeInstructionDataArgs, UtilizeInstructionData>;
...
export declare function utilize(context: Pick<Context, 'programs' | 'eddsa'>, input: UtilizeInstructionAccounts & UtilizeInstructionArgs): TransactionBuilder;
