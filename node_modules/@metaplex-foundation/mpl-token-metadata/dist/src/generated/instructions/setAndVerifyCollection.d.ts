...
export declare function getSetAndVerifyCollectionInstructionDataSerializer(_context: object): Serializer<SetAndVerifyCollectionInstructionDataArgs, SetAndVerifyCollectionInstructionData>;
...
export declare function setAndVerifyCollection(context: Pick<Context, 'programs' | 'identity' | 'payer'>, input: SetAndVerifyCollectionInstructionAccounts): TransactionBuilder;
