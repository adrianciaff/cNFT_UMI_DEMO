...
export declare function getRevokeSaleV1InstructionDataSerializer(_context: object): Serializer<RevokeSaleV1InstructionDataArgs, RevokeSaleV1InstructionData>;
...
export declare function revokeSaleV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: RevokeSaleV1InstructionAccounts & RevokeSaleV1InstructionArgs): TransactionBuilder;
