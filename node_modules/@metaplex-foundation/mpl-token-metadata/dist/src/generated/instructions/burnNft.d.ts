...
export declare function getBurnNftInstructionDataSerializer(_context: object): Serializer<BurnNftInstructionDataArgs, BurnNftInstructionData>;
export declare function getBurnNftInstructionDataSerializer(): Serializer<BurnNftInstructionDataArgs, BurnNftInstructionData>;
export declare function burnNft(context: Pick<Context, 'programs' | 'eddsa'>, input: BurnNftInstructionAccounts): TransactionBuilder;
