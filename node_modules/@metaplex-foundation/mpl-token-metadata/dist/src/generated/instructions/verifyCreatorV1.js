...
function getVerifyCreatorV1InstructionDataSerializer(_context = {}) {
...
function verifyCreatorV1(context, input) {
    ...
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'delegateRecord', input.delegateRecord
        ...
        : [programId, false]);
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'collectionMint', input.collectionMint
        ? [input.collectionMint, false]
        : [programId, false]);
