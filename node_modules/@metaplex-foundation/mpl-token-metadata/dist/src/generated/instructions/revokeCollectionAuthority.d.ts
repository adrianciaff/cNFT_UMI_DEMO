...
export declare function getRevokeCollectionAuthorityInstructionDataSerializer(_context: object): Serializer<RevokeCollectionAuthorityInstructionDataArgs, RevokeCollectionAuthorityInstructionData>;
...
export declare function revokeCollectionAuthority(context: Pick<Context, 'programs' | 'eddsa'>, input: RevokeCollectionAuthorityInstructionAccounts): TransactionBuilder;
