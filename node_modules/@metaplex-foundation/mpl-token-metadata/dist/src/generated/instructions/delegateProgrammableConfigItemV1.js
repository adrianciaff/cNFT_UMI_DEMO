...
function getDelegateProgrammableConfigItemV1InstructionDataSerializer(_context = {}) {
...
function delegateProgrammableConfigItemV1(context, input) {
    ...
    (0, shared_1.addObjectProperty)(resolvingArgs, 'updateAuthority', input.updateAuthority ?? (0, umi_1.publicKey)(resolvedAccounts.authority[0], false));
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'delegateRecord', input.delegateRecord
        ...
        : [
            (0, accounts_1.findMetadataDelegateRecordPda)(context, {
                ...
                delegate: (0, umi_1.publicKey)(input.delegate, false),
            }),
            true,
        ]);
    ...
    (0, shared_1.addObjectProperty)(resolvedAccounts, 'token', input.token ? [input.token, true] : [programId, false]);
