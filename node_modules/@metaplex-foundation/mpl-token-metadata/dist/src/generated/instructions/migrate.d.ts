...
export declare function getMigrateInstructionDataSerializer(_context: object): Serializer<MigrateInstructionDataArgs, MigrateInstructionData>;
export declare function getMigrateInstructionDataSerializer(): Serializer<MigrateInstructionDataArgs, MigrateInstructionData>;
export declare function migrate(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: MigrateInstructionAccounts): TransactionBuilder;
