...
function getSetTokenStandardInstructionDataSerializer(_context = {}) {
...
function setTokenStandard(context, input) {
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.edition, true);
    // Data.
