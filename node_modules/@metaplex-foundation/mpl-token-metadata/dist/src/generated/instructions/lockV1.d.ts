...
export declare function getLockV1InstructionDataSerializer(_context: object): Serializer<LockV1InstructionDataArgs, LockV1InstructionData>;
...
export declare function lockV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: LockV1InstructionAccounts & LockV1InstructionArgs): TransactionBuilder;
