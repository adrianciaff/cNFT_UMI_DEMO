...
export declare function getSetTokenStandardInstructionDataSerializer(_context: object): Serializer<SetTokenStandardInstructionDataArgs, SetTokenStandardInstructionData>;
...
export declare function setTokenStandard(context: Pick<Context, 'programs' | 'eddsa' | 'identity'>, input: SetTokenStandardInstructionAccounts): TransactionBuilder;
