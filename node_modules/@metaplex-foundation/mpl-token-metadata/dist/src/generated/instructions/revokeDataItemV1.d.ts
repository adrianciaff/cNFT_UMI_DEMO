...
/** @deprecated Use `getRevokeDataItemV1InstructionDataSerializer()` without any argument instead. */
export declare function getRevokeDataItemV1InstructionDataSerializer(_context: object): Serializer<RevokeDataItemV1InstructionDataArgs, RevokeDataItemV1InstructionData>;
...
export declare function revokeDataItemV1(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: RevokeDataItemV1InstructionAccounts & RevokeDataItemV1InstructionArgs): TransactionBuilder;
