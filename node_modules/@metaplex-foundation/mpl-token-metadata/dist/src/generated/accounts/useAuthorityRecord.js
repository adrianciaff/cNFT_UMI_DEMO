...
function getUseAuthorityRecordAccountDataSerializer(_context = {}) {
...
function deserializeUseAuthorityRecord(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getUseAuthorityRecordAccountDataSerializer());
}
