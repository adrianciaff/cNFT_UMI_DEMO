...
function getEditionAccountDataSerializer(_context = {}) {
...
function deserializeEdition(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getEditionAccountDataSerializer());
}
