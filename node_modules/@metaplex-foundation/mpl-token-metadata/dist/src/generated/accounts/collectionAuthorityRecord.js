...
function getCollectionAuthorityRecordAccountDataSerializer(_context = {}) {
...
function deserializeCollectionAuthorityRecord(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getCollectionAuthorityRecordAccountDataSerializer());
}
