...
function getMetadataAccountDataSerializer(_context = {}) {
...
function deserializeMetadata(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getMetadataAccountDataSerializer());
}
