...
function getTokenOwnedEscrowAccountDataSerializer(_context = {}) {
...
function deserializeTokenOwnedEscrow(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getTokenOwnedEscrowAccountDataSerializer());
}
