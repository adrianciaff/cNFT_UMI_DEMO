...
function getEditionMarkerV2AccountDataSerializer(_context = {}) {
...
function deserializeEditionMarkerV2(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getEditionMarkerV2AccountDataSerializer());
}
