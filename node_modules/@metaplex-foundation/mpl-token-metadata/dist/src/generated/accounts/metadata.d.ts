...
export declare function getMetadataAccountDataSerializer(_context: object): Serializer<MetadataAccountDataArgs, MetadataAccountData>;
...
export declare function deserializeMetadata(context: object, rawAccount: RpcAccount): Metadata;
