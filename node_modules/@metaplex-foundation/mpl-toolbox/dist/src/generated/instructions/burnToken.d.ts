...
export declare function getBurnTokenInstructionDataSerializer(_context: object): Serializer<BurnTokenInstructionDataArgs, BurnTokenInstructionData>;
...
export declare function burnToken(context: Pick<Context, 'programs' | 'identity'>, input: BurnTokenInstructionAccounts & BurnTokenInstructionArgs): TransactionBuilder;
