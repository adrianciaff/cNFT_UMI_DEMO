...
export declare function getCreateEmptyLutInstructionDataSerializer(_context: object): Serializer<CreateEmptyLutInstructionDataArgs, CreateEmptyLutInstructionData>;
...
export declare function createEmptyLut(context: Pick<Context, 'programs' | 'eddsa' | 'identity' | 'payer'>, input: CreateEmptyLutInstructionAccounts & CreateEmptyLutInstructionArgs): TransactionBuilder;
