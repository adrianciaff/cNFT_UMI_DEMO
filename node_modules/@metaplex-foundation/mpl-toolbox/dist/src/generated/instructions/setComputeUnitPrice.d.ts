 ...
 */
import { Context, SolAmount, TransactionBuilder } from '@metaplex-foundation/umi';
...
export declare function getSetComputeUnitPriceInstructionDataSerializer(_context: object): Serializer<SetComputeUnitPriceInstructionDataArgs, SetComputeUnitPriceInstructionData>;
