...
export declare function getTransferSolInstructionDataSerializer(_context: object): Serializer<TransferSolInstructionDataArgs, TransferSolInstructionData>;
...
export declare function transferSol(context: Pick<Context, 'programs' | 'identity'>, input: TransferSolInstructionAccounts & TransferSolInstructionArgs): TransactionBuilder;
