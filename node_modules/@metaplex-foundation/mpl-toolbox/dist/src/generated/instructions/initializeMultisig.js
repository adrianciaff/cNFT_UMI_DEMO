...
function getInitializeMultisigInstructionDataSerializer(_context = {}) {
...
function initializeMultisig(context, input) {
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.multisig, false);
