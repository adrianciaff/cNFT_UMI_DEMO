...
function getTokenAccountDataSerializer(_context = {}) {
...
function deserializeToken(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getTokenAccountDataSerializer());
}
