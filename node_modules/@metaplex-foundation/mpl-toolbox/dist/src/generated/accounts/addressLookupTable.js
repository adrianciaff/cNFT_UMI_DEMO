...
function getAddressLookupTableAccountDataSerializer(_context = {}) {
...
function deserializeAddressLookupTable(context, rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount ?? context, getAddressLookupTableAccountDataSerializer());
}
