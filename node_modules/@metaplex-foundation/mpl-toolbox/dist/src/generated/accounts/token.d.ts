...
export declare function getTokenAccountDataSerializer(_context: object): Serializer<TokenAccountDataArgs, TokenAccountData>;
...
export declare function deserializeToken(context: object, rawAccount: RpcAccount): Token;
